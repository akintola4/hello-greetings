...
export interface Greeting {
  ...
  etymology: string
  /** 0-360. L and C are locked by the theme, so only hue varies. */
  accentHue: number
...
export const GREETINGS: Greeting[] = [
  {
    ...
    note: 'The youngest word on this list by a wide margin. Before the 1800s it was not a greeting at all — it was a shout, used to hail a ferryman across water or to call off hounds. It became hello because Thomas Edison proposed it as the right thing to say into a telephone, against Alexander Graham Bell, who wanted "ahoy". A machine taught us this one.',
  ...
  },
  {
    ...
    note: 'Not a word but a wish, and one that obliges a reply: wa ʿalaykumu s-salām, and upon you, peace. The grammar is plural even when you greet one person, which folds in everyone standing with them. It is spoken daily by well over a billion people across some two dozen countries — which is exactly why no single flag belongs beside it.',
  ...
  },
  {
    ...
    script: 'latn',
    region: 'South Africa',
    note: 'The answer is yebo, sawubona — yes, I see you too. It is a greeting that makes a claim: that you were not visible until I acknowledged you, and now you are. The plural form, sanibonani, addresses a group. Few greetings state their own function so plainly, and almost none of them mean as much.',
    etymology: 'From ukubona, "to see" — literally "we see you", the plural carrying respect.',
    accentHue: 95,
    typeScale: 1,
    tracking: -0.02,
  },
  ...
  },
  {
    ...
    note: 'The same wish as the Russian one, arrived at independently: your health. Use sou for one person you know, sas for a stranger or for several. Greeks also kept khaire from the ancient world — "rejoice" — which is what a runner is said to have gasped at Marathon before dying. Health for the living, joy for the victorious.',
  ...
  },
  {
    ...
    script: 'ethi',
    region: 'Ethiopia',
    note: 'Written in Geʽez script, one of the few writing systems in daily use that was invented in Africa and never replaced. Each character is a syllable, not a letter. The greeting itself belongs to the same Semitic family as shalom and salām — three peoples, three scripts, one word for peace, separated by a few thousand years of drift.',
  ...
  },
  {
    ...
    note: 'You wish a stranger victory, and they answer gagimarjos — victory to you too. The story attached to it is that soldiers returning from war announced the outcome before anything else, and the announcement became the greeting. Georgian is written in an alphabet shared with no other language, and belongs to no family shared with any neighbour.',
  ...
  },
  {
    ...
    romanization: 'aloha',
    ipa: '/əˈloʊhɑ/',
    literal: 'the presence of breath',
    language: { name: 'Hawaiian', endonym: 'ʻŌlelo Hawaiʻi', iso639: 'haw' },
    script: 'latn',
    region: 'Hawaiʻi',
    note: 'Commonly read as alo, presence or face, with hā, breath — the sharing of breath between two people, which is also what happens in the honi, where foreheads and noses touch. The word means hello, goodbye, and love. It has been printed on more souvenirs than almost any other word here, and it survived a period when the language itself was banned in schools.',
    etymology: 'Usually parsed as alo, "presence, face", with hā, "breath".',
    accentHue: 130,
    typeScale: 1.05,
    tracking: -0.02,
  },
  ...
  },
  {
    ...
    script: 'latn',
    region: 'Finland',
    note: 'Health again — the third time on this list, from a language related to none of the others. Finnish greeting culture is famously economical: the word, a nod, and no obligation to fill the silence that follows. Silence between two Finns is not an awkwardness to be repaired. It is a normal condition of being in a room together.',
  ...
  },
  {
    ...
    note: 'Written in syllabics, where the direction a character points tells you its vowel — the same shape rotated four ways. The system was adapted for Inuktitut from one devised for Cree, and it is now on road signs and passports across Nunavut. Among the greetings here it is the one with the fewest speakers, and the one working hardest to keep them.',
  ...
  },
  {
    ...
    note: 'A question so short it barely is one. Alongside it sits Ndeewo, the respectful form you owe an elder. Igbo has hundreds of dialects and Standard Igbo is a twentieth-century construction assembled from several of them \u2014 so which greeting you reach for, and how you tone it, quietly says where you are from.',
  ...
  },
  {
    ...
    ipa: '/ha\u028a fa/',
    literal: 'how far along?',
    language: { name: 'Nigerian Pidgin', endonym: 'Naij\u00e1', iso639: 'pcm' },
    script: 'latn',
    region: 'Nigeria and much of West Africa',
    note: 'English words running on West African grammar, spoken by something like a hundred million people \u2014 more than speak it as a mother tongue anywhere in Europe. The answer is "I dey": I am here. For decades it was dismissed as broken English by people who spoke it fluently at home. It now has its own BBC news service.',
  ...
  },
  {
    id: 'efi-mesiere',
    word: 'Mesiere',
    romanization: 'mesiere',
    ipa: '/me\u0301sie\u0300re/',
    language: { name: 'Efik', endonym: 'Usem Efik', iso639: 'efi' },
    script: 'latn',
    region: 'Cross River, southeastern Nigeria',
    note: 'An everyday greeting offered to anyone, of any age, at any hour \u2014 Efik makes fewer demands about rank than most of its neighbours. The language was among the first in Nigeria to be written down and printed, by Presbyterian missionaries in Calabar from the 1840s, which is why an Efik dictionary is older than most European colonial borders in Africa.',
    etymology: 'A greeting formula; unusually for this list, it resists a tidy literal translation.',
    accentHue: 198,
    typeScale: 1.0,
    tracking: -0.02,
  },
  {
    id: 'kr-ushe',
    word: 'Ush\u00e9-ush\u00e9',
    romanization: 'ushe-ushe',
    ipa: '/u\u0283e u\u0283e/',
    language: { name: 'Kanuri', endonym: 'Kanuri', iso639: 'kr' },
    script: 'latn',
    region: 'Borno and the Lake Chad basin',
    note: 'Doubled, the way a greeting often is when it is meant warmly. Kanuri is the language of the old Kanem\u2013Bornu Empire, which lasted a thousand years, and it is the only entry here belonging to the Nilo-Saharan family \u2014 related to nothing else on this page. Around Lake Chad it is still the language people trade in.',
    etymology: 'A reduplicated greeting particle; repetition itself carries the warmth.',
    accentHue: 268,
    typeScale: 0.9,
    tracking: -0.02,
  },
